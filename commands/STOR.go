...
func NewSTORCommand(parameteres []string, currentPath string, controlConn TcpConnectionWrapper, user *utils.User) STOR {
	return STOR{
...
func (cmd STOR) Execute() (int, error) {
	...
	if err := os.MkdirAll(path.Dir(filepath), 6660); err != nil {
		return codes.RequestedActionNotTaken, nil
	}
